...
Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/salah-mohammed/LocationPickeer'
  ...
  s.authors             = { 'salah mohamed' => 'salah.mohamed_1995@hotmail.com' }
  # Or just: s.author    = ''
  # s.authors            = { '' => '' }
  ...
  s.source = { git: 'https://github.com/salah-mohammed/LocationPickeer.git', tag: s.version.to_s }
  ...
  s.source_files  = '*', 'LocationPickeer/*'
...
s.pod_target_xcconfig = { 'INFOPLIST_FILE' => '${PODS_TARGET_SRCROOT}/path/to/Info.plist' }
